...
public class Operation: NSOperation {
    ...
    */
    ...
    private var state: State {
        ...
        set(newState) {
            ...
            */
            ...
            print("\(name ?? "UNNAMED_OPERATION") -  \(state) -> \(newState)")
    ...
    public override func addDependencies(dependencies: [NSOperation]) {
    ...
    */
    public func execute() {
        print("\(self.dynamicType) must override `execute()`. - name: \(name)")
